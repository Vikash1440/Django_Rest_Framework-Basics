...
# function based views for student table
@api_view(['GET','POST'])
...
# class based views for employee table
...
# generic class based views for employee table
...
# more simplified generic class based views for employee table
...
"""
# ViewSet class based views for employee table
